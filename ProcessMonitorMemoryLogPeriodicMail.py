...
def MailSender(filename,time):
    try:
        fromaddr = "amolmali.snk19@gmail.com"
        toaddr = "tejaskatkade.skn.it@gmail.com"
        ...
        Please find attached ducument which contains Log of Running process in my PC.
        Log file is created at : %s
        
        This is auto gennerated mail.
    
        I cannot recive the call due to class.
        Thanks & Regards,
        Amol Mali
        ...
        s.login(fromaddr,"hxou cbsf jmkh tbbp")
